...
var grokOgIdentity = { "site": {
	"title": "Revisitas",
	"color": "3D5563",
	"description": "Cuaderno de revisitas por territorio. 33 territorios, hasta 10 notas personales en cada uno."
} };
//#endregion
...
var _lazy_ur7wqi = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_ur7wqi
	};
	return ((_m, p) => {
		return {
			data,
