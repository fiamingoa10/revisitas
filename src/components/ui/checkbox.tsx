...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        "peer relative size-5 shrink-0 rounded-sm border border-border bg-card shadow-lift outline-none transition-[background-color,border-color,box-shadow] duration-150",
